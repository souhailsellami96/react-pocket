                ...
                <div className="buy__container" >
                    <div><h3> BUY</h3></div>
                        <div className='buy__card'>
                            ...
                            <div className='coin__list' className='select'>
                                    <select>
                                    {
                                       data.map((choice)=>{
                                        return <option val={choice.title} className='option__style'>   {choice.title} </option>
                                   }) 
                                    }
                                    </select>
                ...
                <div className="buy__container" >
                    <div><h3> SELL</h3></div>
                        ...
                        <div className='coin__list' className='select'>
                                    ...
                                    {
                                       data.map((choice)=>{
                                        return <option className='option__style'>  {choice.title} </option>
                                   }) 
                                    }
                                    </select>
                                    <span class="focus"></span>
